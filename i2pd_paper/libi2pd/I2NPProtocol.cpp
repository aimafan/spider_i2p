		...
		if (msg)
		{
			...
			switch (typeID)
			{
				case eI2NPTunnelData:{
					// LogToFile("I2NPProtocol处理TunnelData " + length_str);
					if (!msg->from)
						i2p::tunnel::tunnels.PostTunnelData (msg);
				}
				break;
				case eI2NPTunnelGateway:{
					// LogToFile("I2NPProtocol处理TunnelGateway " + length_str);
					if (!msg->from)
						i2p::tunnel::tunnels.PostTunnelData (msg);
				}
				break;
				case eI2NPGarlic:
				{
					// LogToFile("I2NPProtocol处理Garlic " + length_str);
				...
				case eI2NPDatabaseStore:
					// LogToFile("I2NPProtocol处理DatabaseStore " + length_str);
				case eI2NPDatabaseSearchReply:	{
					// LogToFile("I2NPProtocol处理DatabaseSearchReply " + length_str);
				...
				case eI2NPDatabaseLookup:{
					// LogToFile("I2NPProtocol处理DatabaseLookup " + length_str);
				...
				{
					// LogToFile("I2NPProtocol处理DeliveryStatus " + length_str);
					if (msg->from && msg->from->GetTunnelPool ())
				...
				case eI2NPTunnelTest:{
					// LogToFile("I2NPProtocol处理TunnelTest " + length_str);
					if (msg->from && msg->from->GetTunnelPool ())
						msg->from->GetTunnelPool ()->ProcessTunnelTest (msg);
				}
				break;
				case eI2NPVariableTunnelBuild:
					// LogToFile("I2NPProtocol处理VariableTunnelBuild " + length_str);
				case eI2NPTunnelBuild:
					// LogToFile("I2NPProtocol处理TunnelBuild " + length_str);
				case eI2NPShortTunnelBuild:{
					// LogToFile("I2NPProtocol处理ShortTunnelBuild " + length_str);
				...
				break;
				case eI2NPVariableTunnelBuildReply:
					// LogToFile("I2NPProtocol处理VariableTunnelBuildReply " + length_str);
				case eI2NPTunnelBuildReply:
					// LogToFile("I2NPProtocol处理TunnelBuildReply " + length_str);
				case eI2NPShortTunnelBuildReply:{
					// LogToFile("I2NPProtocol处理ShortTunnelBuildReply " + length_str);
					// forward to tunnel thread
					i2p::tunnel::tunnels.PostTunnelData (msg);
				}
				break;
